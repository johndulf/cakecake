    ...
    <div id="products-app" style="margin-top:50px;">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="row" v-for="product in products" style="border:1px solid Blue; margin: 10px;"  >
                        ...
                        <div class="col-md-8" style="font-size: 25px;">
                            ...
                            <button class="btn-success btn-sm" @click="fnGetProdcuts(product.productid)"><a>Update</a></button>
                             <?php endif ?>
                        </div>
                    </div>
                </div>
